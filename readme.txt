...
Este programa es (de momento al menos) gratis, pero su reproducción y redistribución está prohibida. Su uso está permitido para fines comerciales (por ejemplo, labs que digitalicen), pero el proyecto lo llevo yo solo y el soporte puede ser escaso.
...
-All-gamma
	Gamma global de la imagen. El valor específico está definido por 4**((gamma / 100) * 2 - 1.6)
-R/G/B gamma
	Gamma por canal de la imagen. El valor específico está definido por 3**((gamma / 100) * 2 - 1.6)
-Autoset:
